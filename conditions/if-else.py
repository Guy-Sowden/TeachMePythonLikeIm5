...
# ------------------------------------------------------------------------------------
# Challenge: Using your knowlege of operations, write two conditions where it says
# "replace-me" to check if your car is going bellow speed limit and above the minuimn
